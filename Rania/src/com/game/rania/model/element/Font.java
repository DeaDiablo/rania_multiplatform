...
public class Font {
	...
	static private String charaters = FreeTypeFontGenerator.DEFAULT_CHARS
			+ "ÉÖÓÊÅÍÃØÙÇÕÚÔÛÂÀÏĞÎËÄÆİß×ÑÌÈÒÜÁŞ¨éöóêåíãøùçõúôûâàïğîëäæıÿ÷ñìèòüáş¸";
	...
	static public void loadFont(String fontFile, int... fontSizes) {
		...
		for (int i = 0; i < fontSizes.length; i++) {
			...
			BitmapFont font = generator
					.generateFont(fontSize, charaters, false);
