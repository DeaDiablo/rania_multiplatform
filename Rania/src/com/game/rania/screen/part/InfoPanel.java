...
public class InfoPanel extends Group implements Part {
	...
	public void setStarInfo(Star star) {
		...
		info.addLine("Позиция: ["
				+ Controllers.locController.getOutputX(star.position.x) + ", "
				+ Controllers.locController.getOutputY(star.position.y) + "]");
	}
	...
	public void loadPart() {
		...
		info = new TextList(
				...
				new MultilineText(
						"",
						Font.getFont("data/fonts/Arial.ttf", 20),
						new Color(1, 1, 1, 1),
